const showInputError = (errorElement, errorMessage, errorInput, {
  inputErrorClass,
  errorClass
}) => {
...
const hideInputError = (errorElement, errorInput, {
  inputErrorClass,
  errorClass
}) => {
...
const checkValidInput = (inputElement, formElement, {
  ...
  if (!inputElement.validity.valid) {
    showInputError(errorElement, inputElement.validationMessage, inputElement, {
      inputErrorClass,
      errorClass
    });
  } else {
